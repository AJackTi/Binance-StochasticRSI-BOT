...
trade_upper_stoch_validator = int(getenv('TRADE_TIME_FRAME_UPPER_VALIDATOR', 0))
trade_upper_stoch_validator_value = getenv('TRADE_TIME_FRAME_UPPER_VALIDATOR_VALUE', "1h")
